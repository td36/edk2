...
class SettingsManager(UpdateSettingsManager, SetupSettingsManager, PrEvalSettingsManager):
    ...
    def AddCommandLineOptions(self, parserObj):
        parserObj.add_argument('-u', '--UnitTest', dest='ShellUnitTestList', type=str,
            help='Optional - Key:Value that contains Shell UnitTest list and corresponding DscPath you want to test.'
    ...
    def GetPlatformDscAndConfig(self) -> tuple:
        ...
        This Policy 4 can only be applied when PackagesSupported only contains OvmfPkg.
        '''

  ...
  )
{
  ...
  Status = LzmaUefiDecompressGetInfo((VOID *)SourceAddress, ImageSize, &DestSize, &ScratchSize);
  if (EFI_ERROR (Status)) {
  ...
  Status = LzmaUefiDecompress ((VOID *)SourceAddress, ImageSize, MyDestAddress, ScratchAddress);
  *Dest = MyDestAddress;

...
static CPU_PAGE_TABLE_LIB_RANDOM_TEST_CONTEXT  mTestContextPaging4Level    = { Paging4Level, 100, 20, MANUAL_CHANGE_PAGE_TABLE|USE_RANDOM_ARRAY|TEST_REMAP_WRITEABLE };
static CPU_PAGE_TABLE_LIB_RANDOM_TEST_CONTEXT  mTestContextPaging4Level1GB = { Paging4Level1GB, 100, 20, MANUAL_CHANGE_PAGE_TABLE|USE_RANDOM_ARRAY|TEST_REMAP_WRITEABLE };
static CPU_PAGE_TABLE_LIB_RANDOM_TEST_CONTEXT  mTestContextPaging5Level    = { Paging5Level, 100, 20, MANUAL_CHANGE_PAGE_TABLE|USE_RANDOM_ARRAY |TEST_REMAP_WRITEABLE };
static CPU_PAGE_TABLE_LIB_RANDOM_TEST_CONTEXT  mTestContextPaging5Level1GB = { Paging5Level1GB, 100, 20, MANUAL_CHANGE_PAGE_TABLE|USE_RANDOM_ARRAY |TEST_REMAP_WRITEABLE };
